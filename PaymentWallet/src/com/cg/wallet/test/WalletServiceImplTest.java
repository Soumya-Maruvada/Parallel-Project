...
public class WalletServiceImplTest {
	...
	public void testFundTransferEqualsSender() throws Exception, WalletException {
		...
		wallet = walletDao.findWallet(101);
		Wallet walletTarget = walletDao.findWallet(104);
		boolean wTest = walletService.fundTransfer(wallet, walletTarget, 500);
		double bal = wallet.getBalance();
		assertEquals(100500, bal, 0);
	}
	@Test
	public void testFundTransferEqualsReceiver() throws Exception, WalletException {
		...
		assertEquals(2500, bal, 0);
	}
	@Test
	public void testFundTransferNotEqualsSender() throws Exception, WalletException {
		
		wallet = walletDao.findWallet(101);
		Wallet walletTarget = walletDao.findWallet(104);
		boolean wTest = walletService.fundTransfer(wallet, walletTarget, 500);
		double bal = wallet.getBalance();
		assertNotEquals(100500, bal, 0);
	}
	@Test
	public void testFundTransferNotEqualsReceiver() throws Exception, WalletException {
		
		wallet = walletDao.findWallet(101);
		Wallet walletTarget = walletDao.findWallet(104);
		boolean wTest = walletService.fundTransfer(wallet, walletTarget, 500);
		double bal = walletTarget.getBalance();
		assertNotEquals(2500, bal, 0);
	}
